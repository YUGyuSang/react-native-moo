  ...
  export const Footer = () =>{
    return(
      <View style={[styles.container, styles.footer]}>
        ...
        <TouchableOpacity
            style={[styles.touchStyle]}><FontAwesomeIcon icon={faHouse} size={32} style={[styles.fontIcon]}/><Text style={{ color : 'white', fontSize: 30, textAlign:'center',}}>홈</Text></TouchableOpacity>
            <View style={{
                width:1,
                height:'100%',
            ...
            <TouchableOpacity
            style={[styles.touchStyle]}><FontAwesomeIcon icon={faBars} size={32} style={[styles.fontIcon]}/><Text style={{ color : 'white', fontSize: 30, textAlign:'center',}}>전체메뉴</Text></TouchableOpacity>
        </View>
      </View>
    );
  }
